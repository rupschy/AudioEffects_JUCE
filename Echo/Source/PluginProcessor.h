...
public:
    ...
    // if it wasnt atomic, audio thread would be halted and artifacting will occur
    // Atomic datatype can be used with different things such as int or float 
    
private:
//    This creates a point for the beginning of the echo effect
//    echo.prepare in PProcessor.cpp needs to change to echo->prepare
//    Echo * echo;
